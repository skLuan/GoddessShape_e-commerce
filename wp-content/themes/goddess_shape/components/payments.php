<div class="flex  flex-col w-full justify-starr items-center font-semibold bg-transparent relative z-20">
    <div class="flex flex-col w-[90%] lg:w-[60%] items-center py-2">
        <div class="flex flex-col items-center">
            <img class="flex h-16 w-20 lg:h-24 lg:w-24" src="<?= get_stylesheet_directory_uri() ?>/assets/img/payments logos/pagos.png" alt="">
        ...
        <h3 class="flex font-champagne_limousines text-black-gs leading-5 text-lg lg:text-xl font-light items-center">Say goodbye to payment headaches!</h3>
        <h3 class="flex font-champagne_limousines text-black-gs leading-5 text-lg lg:text-xl font-light py-4">Our online store accepts a variety of payment methods, so you can purchase your favorite shapewear worry-free. Shop with confidence.</h3>
