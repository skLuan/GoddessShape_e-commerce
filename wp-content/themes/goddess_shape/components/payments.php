<div class="flex py-16 flex-col w-full justify-center items-center font-semibold bg-white relative z-20">
    <div class="flex items-center lg:flex-col justify-center pb-1 w-36 lg:pb-8">
        <img class="flex w-9 lg:w-12" src="<?= get_stylesheet_directory_uri() ?>/assets/img/payments logos/pagos_amarillo.png-2.png" alt="">
        <h1 class="flex font-champagne_limousines text-red-soft text-2xl leading-5">Pay with</h1>
    </div>
    <div class="grid grid-cols-2 lg:grid-cols-4 ml-3 lg:ml-0 my-4 h-30 w-full ">
