<!-- tabBar -->
<div class="flex lg:hidden items-center justify-between w-5/6 px-5 pt-3 pb-2 translate-x-1/2 right-1/2 fixed bottom-[10%] shadow-xl rounded-lg bg-white z-50" id="tab_bar">
