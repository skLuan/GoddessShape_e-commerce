...
<div class="grid grid-cols-1 lg:grid-cols-12 h-auto">

    <div class="grid grid-cols-2 lg:col-span-7 gap-5 items-center justify-center w-full h-auto overflow-hidden bg-white px-5">
        <div class="relative lg:flex flex-col justify-center h-full px-8">
            <h2 class="flex my-2 font-champagne_limousines text-lg font-bold text-center mx-auto text-red-soft mt-[10%]">Acabado 1</h2>
            <img class="absolute left-3 -rotate-45 mx-auto my-auto z-0 opacity-30 -translate-y-1/3 lg:-translate-y-0" width="90%" src="<?= IMAGE . 'Home/sol_sin_centro.png' ?>" alt="">
        ...
        <div class="relative lg:flex flex-col justify-center h-full px-8 overflow-hidden ">
            <h2 class="flex my-2 font-champagne_limousines text-lg font-bold text-center mx-auto text-red-soft mt-[10%]">Acabado 2</h2>
            <img class="absolute left-3 -rotate-45 mx-auto my-auto z-0 opacity-30 -translate-y-1/3 lg:-translate-y-0" width="90%" src="<?= IMAGE . 'Home/sol_sin_centro.png' ?>" alt="">
