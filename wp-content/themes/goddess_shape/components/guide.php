            ...
            <div class="flex items-center justify-center w-full">
                <div class="flex items-center flex-col w-[90%] lg:w-[60%]">
                    <div class="flex items-center justify-center">
                        <img class="flex h-28 w-16 lg:h-40 lg:w-24" src="<?= IMAGE ?>Home/tallas_degradado3.png" alt="">
                    </div>
        ...
        <div class="flex flex-col w-full h-auto items-center">
            ...
            <div class="flex flex-row items-center justify-center w-[90%] lg:w-[60%] h-auto overflow-hidden">
                <div class="flex flex-col justify-center h-full">
                    ...
                    <div class="flex z-10  flex-row h-28 w-28 bg-gray-card rounded-full mx-auto mb-2">
                        <img class="flex h-28 w-28 rounded-full" src="<?= IMAGE ?>Home/power_net_textura.png" alt="">
                    </div>
                ...
                <div class="flex flex-col justify-center h-full overflow-hidden ">
                    ...
                    <div class="flex z-10 h-28 w-28 bg-gray-card rounded-full mx-auto mb-2">
                        <img class="flex h-28 w-28 rounded-full" src="<?= IMAGE ?>Home/cierre_parte_inferior.png" alt="">
                    </div>
                    <h2 class="flex ml-2 text-lg lg:font-normal leading-5 font-light">Lorem ipsum dolor sit amet, consectetur adipiscing elit</h2>
                </div>
            </div>
