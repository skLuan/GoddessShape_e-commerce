...
<div class="flex flex-col w-full items-center justify-start py-2 <?= esc_attr($classes); ?>">
    ...
    <div class="flex flex-col w-[90%] lg:w-[60%] items-center text-left">
        ...
        <h2 class="flex font-champagne_limousines text-black-gs  text-xl lg:text-3xl  font-light items-center py-3">Track your order  <a target="_blank" class="ml-3 hover:text-orange-400 transition-colors font-bold underline" href="https://es-tools.usps.com/go/TrackConfirmAction_input"> here</a></h2>
    </div>
</div>