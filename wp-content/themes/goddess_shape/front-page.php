...
<section class="flex flex-row overflow-x-auto h-120 w-full mt-3 mr-2 px-5">
    <?php
    $args = [
        'limit' => -1,
    ];
    ...
    ?>
        <div class="relative flex flex-col w-56 h-120 bg-transparent rounded-lg mr-5 last:mr-0">
            ...
            <!-- contenedor info -->
            <div class="flex flex-col z-20 h-80 px-5 py-2 justify-around mb-4 w-52 bg-white shadow-2xl rounded-lg">
...
<!-------------------------------------------------------------------------------- -->
<!---------------------------------------------- pay with -->
<div class="flex py-16 flex-col w-full justify-center items-center font-semibold bg-white-notWhite">
...
<div class="w-full h-100 bg-white-notWhite px-5">
